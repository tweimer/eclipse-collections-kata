...
public class Exercise6Test extends CompanyDomainForKata
{
    ...
    {
        MutableDoubleList sortedTotalValues = company.getCustomers().collectDouble(Customer::getTotalOrderValue).sortThis();
    ...
    {
        double maximumTotalOrderValue = company.getCustomers().collectDouble(Customer::getTotalOrderValue).max();
    ...
    {
        company.getCustomers().select(customer -> "London".equals(customer.getCity())).flatCollect(Customer::getOrders).each(Order::deliver);
